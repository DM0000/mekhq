...
public class Campaign implements ITechManager {
    ...
    /**
     * Adds a {@link StrategicFormation} to the {@code strategicFormations}
     * {@link Hashtable} using
     * {@code forceId} as the key.
     *
     * @param strategicFormation the {@link StrategicFormation} to be added to the
     *                           {@link Hashtable}
     */
    ...
    /**
     * Removes a {@link StrategicFormation} from the {@code strategicFormations}
     * {@link Hashtable}
     * using {@code forceId} as they key.
     *
     * @param forceId the key of the {@link StrategicFormation} to be removed from
     *                the {@link Hashtable}
     */
    ...
    /**
     * Returns the {@link Hashtable} containing all the {@link StrategicFormation}
     * objects after
     * removing the ineligible ones. Although sanitization might not be necessary,
     * it ensures that
     * there is no need for {@code isEligible()} checks when fetching the
     * {@link Hashtable}.
     *
     * @return the sanitized {@link Hashtable} of {@link StrategicFormation} objects
     *         stored in the
     *         current campaign.
     */
        ...
        for (StrategicFormation strategicFormation : strategicFormations.values()) {
            if (!strategicFormation.isEligible(this)) {
                ...
                try {
                    ...
                    // as this just means it has been deleted at some point and not removed
                    // correctly.
                }
            }
        }
     ...
     * Calls the {@code getStrategicFormationsTable()} method to sanitize the
     * {@link Hashtable}
     * before conversion to {@link ArrayList}.
     *
     * @return an {@link ArrayList} of all the {@link StrategicFormation} objects in
     *         the
     *         {@code strategicFormations} {@link Hashtable}
     */
    ...
    public void importScenario(Scenario scenario) {
        ...
        linkedScenarios.put(scenario.getLinkedScenario(), scenario);
    }
    ...
    public void addScenario(Scenario s, Mission m, boolean suppressReport) {
        ...
        m.addScenario(s);
        scenarios.put(id, s);
        linkedScenarios.put(s.getLinkedScenario(), s);
     ...
     *
     * @return the senior administrator with a command role, or {@code null} if no
     *         such
    ...
    public @Nullable Person getSeniorAdminCommandPerson() {
        ...
        for (Person person : getAdmins()) {
            if (person.getPrimaryRole().isAdministratorCommand()
    ...
    private void processNewDayATB() {
        ...
        if (getLocalDate().getDayOfWeek() == DayOfWeek.MONDAY) {
            ...
            // Training Experience - Award to eligible training Strategic Formations on
            // active contracts
     ...
     *
     * @param l The {@link StrategicFormation} to calculate XP to award for
     *          training.
     */
